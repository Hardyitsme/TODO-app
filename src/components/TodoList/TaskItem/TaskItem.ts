import { editTodoListItem, TodoItem } from "./../TodoList";
import { formatDate } from "../../../utils/formatDate";
import { editItemForm } from "../../EditItemForm/EditItemForm";
import { openModal } from "../../Modal/Modal";
import { deleteTodoItem } from "../TodoList";
import "./TaskItem.css";
...
export function createTodoListItem(todoItem: TodoItem) {
  const { title: itemText, id, isComplete } = todoItem;
  ...
  isCompleteCheckbox.className = "task-item-checkbox";
  isCompleteCheckbox.type = "checkbox";
  isCompleteCheckbox.defaultChecked = isComplete;
  wrapper.appendChild(isCompleteCheckbox);
  ...
  editButton.addEventListener("click", function () {
    const editItemFormHTML = editItemForm(todoItem);

    openModal({ title: "Изменение задачи", children: editItemFormHTML });
  });

  isCompleteCheckbox.addEventListener("change", (e: any) => {
    editTodoListItem({ ...todoItem, isComplete: e.target.checked });
  });
